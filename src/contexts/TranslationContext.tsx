...
const translations: Record<Locale, Record<string, any>> = {
  es: {
    ...
    kiosk: {
      ...
      pos: {
        ...
        mustSelectVenue: 'Debes seleccionar una sede para continuar',
        venueLockedWithProducts: 'La sede no se puede cambiar con productos en el carrito',
        selectSize: 'Seleccionar Talle',
        selectSizeLabel: 'Selecciona un talle:',
        selectedSize: 'Talle seleccionado:',
        noSizesAvailable: 'No hay talles disponibles para este producto',
      ...
      reports: {
        ...
        charts: {
          ...
          byCategoryDesc: 'Distribución de ingresos por categoría de producto',
          topByCategory: 'Productos destacados por categoría',
          venueComparison: 'Comparativa por Sede',
          venueComparisonDesc: 'Rendimiento de ventas por sede',
  ...
  tournaments: {
    ...
    teamsPage: {
      ...
      playersDescription: 'Lista de jugadores inscritos en el torneo Americano',
      ...
      noPlayersRegistered: 'No hay jugadores inscritos',
      noTeamsDescription: 'Este torneo aún no tiene equipos registrados. Los equipos aparecerán aquí una vez que se inscriban.',
      noPlayersDescription: 'Este torneo aún no tiene jugadores registrados. Los jugadores aparecerán aquí una vez que se inscriban.',
      // Stats translations
      fullCapacity: 'Cupo completo',
      teamsRemaining: 'Faltan {count} equipos',
      playersRemaining: 'Faltan {count} jugadores',
      paidTeamsTitle: 'Equipos Pagados',
      paidPlayersTitle: 'Jugadores Pagados',
      ofTotal: 'del total',
      noTeams: 'Sin equipos',
    ...
    adminRegister: {
      ...
      titlePlayer: 'Registrar Jugador',
      description: 'Inscribe un equipo en el torneo desde el panel de administración',
      descriptionPlayer: 'Inscribe un jugador en el torneo Americano desde el panel de administración',
      ...
      validation: {
        ...
        playerRequired: 'Debe seleccionar un jugador',
      ...
      success: {
        ...
        titlePlayer: '¡Jugador Registrado!',
        registeredIn: 'registrados en'
      },
      registering: 'Registrando Equipo...',
      registeringPlayer: 'Registrando Jugador...',
      registerTeam: 'Registrar Equipo',
      registerPlayer: 'Registrar Jugador',
      playerSelector: {
      ...
      teamSummary: {
        ...
        titlePlayer: 'Jugador seleccionado',
        complete: 'Completo',
        players: 'Jugadores',
        player: 'Jugador',
        player1: 'Jugador 1',
  ...
  clubName: 'Padel Club',
    ...
    kiosk: {
      ...
      pos: {
        ...
        mustSelectVenue: 'You must select a venue to continue',
        venueLockedWithProducts: 'Venue cannot be changed with products in the cart',
        selectSize: 'Select Size',
        selectSizeLabel: 'Select a size:',
        selectedSize: 'Selected size:',
        noSizesAvailable: 'No sizes available for this product',
      ...
      reports: {
        ...
        charts: {
          ...
          byCategoryDesc: 'Revenue distribution by product category',
          topByCategory: 'Top products by category',
          venueComparison: 'Venue Comparison',
          venueComparisonDesc: 'Sales performance by venue',
  ...
  tournaments: {
    ...
    teamsPage: {
      ...
      playersDescription: 'List of players registered in the Americano tournament',
      registerTeam: 'Register Team',
      ...
      noPlayersDescription: 'This tournament does not have any registered players yet. Players will appear here once they register.',
      // Stats translations
      fullCapacity: 'Full capacity',
      teamsRemaining: '{count} teams remaining',
      playersRemaining: '{count} players remaining',
      paidTeamsTitle: 'Paid Teams',
      paidPlayersTitle: 'Paid Players',
      ofTotal: 'of total',
      noTeams: 'No teams',
    ...
    adminRegister: {
      ...
      title: 'Register Team',
      titlePlayer: 'Register Player',
      description: 'Register a team in the tournament from the administration panel',
      descriptionPlayer: 'Register a player in the Americano tournament from the administration panel',
      ...
      validation: {
        ...
        playerRequired: 'Must select a player',
      ...
      success: {
        ...
        titlePlayer: 'Player Registered!',
        registeredIn: 'registered in'
      },
      registering: 'Registering Team...',
      registeringPlayer: 'Registering Player...',
      registerTeam: 'Register Team',
      registerPlayer: 'Register Player',
      playerSelector: {
        selected: 'Selected',
