    ...
    <Link href={`/leagues/${league.id}`}>
      <div className="relative bg-white dark:bg-gray-800/50 rounded-lg sm:rounded-xl shadow-sm hover:shadow-md dark:shadow-lg transition-all duration-300 p-4 sm:p-5 lg:p-6 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 group">
        ...
        <div className="flex items-center justify-between mb-3 sm:mb-4 gap-2">
          <span className="px-2 sm:px-2.5 py-0.5 rounded-full text-xs sm:text-sm font-medium bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 truncate">
            {category?.name || t('categoryNotFound')}
          </span>
          <span className={`px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium flex-shrink-0 ${getStatusStyle(league.status)}`}>
